...
<div class="page-shell">
    <section class="panel panel--wide hr-panel">
        <h1>Desarrollo de CRM (Módulo Recursos Humanos)</h1>
        <h2>Formulario Personal</h2>

        <nav class="tab-row">
            <a class="tab-item active" href="#">Recursos Humanos</a>
            <a class="tab-item" href="#">Soporte</a>
            <a class="tab-item" href="#">Comunidad</a>
        </nav>

        <div class="subtab-row">
            <a class="subtab-item active" href="#">Personal</a>
            <a class="subtab-item" href="#">Desempeño</a>
            <a class="subtab-item" href="#">Objetivos</a>
            <a class="subtab-item" href="#">Auditoría</a>
        </div>
        ...
        <div class="module-header">
            ...
            <div class="module-actions">
                <button type="button" class="btn-secondary btn-inline">Exportar</button>
                <button type="button" class="btn-primary btn-inline">Agregar Empleado</button>
            </div>
        </div>
        ...
        <div class="subtab-row media-tabs">
            <a class="subtab-item active" href="#">Galería de Fotos</a>
            <a class="subtab-item" href="#">Tabla Detallada</a>
        </div>
